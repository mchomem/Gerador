...
/**
 * Classe cujo objetivo é disponibilizar informações básicas como nome e
 * versionamento do projeto.
 * 
 * Pesquisas em: http://www.hardware.com.br/artigos/sistemas-versoes/
...
public class InfoProjeto {
	...
	public static String obterNomeEVersao() {
		...
		return NOME_PRODUTO + " - " + VERSAO_MAIOR + "." + VERSAO_MENOR + "." + CORRECAO + (RC ? " RC" : "");
	...
	public static String obterVersao() {
		...
		return VERSAO_MAIOR + "." + VERSAO_MENOR + "." + CORRECAO;
