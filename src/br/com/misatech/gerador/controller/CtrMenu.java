...
public class CtrMenu implements ActionListener, ComponentListener {
    ...
    private void ativarTemaNimbus() {
        ...
        try {
        	...
        	// Caso houver uma falha ao carregar o tema Nimbus, carrega o tema Swing do java puro. 
            JFrame.setDefaultLookAndFeelDecorated(true);
            JDialog.setDefaultLookAndFeelDecorated(true);
    ...
    private void iniciarSplash() {
		...
		while(this.frmSplash.isVisible()) {
			...
			/* Não executa nada dentro do while
			 * apenas impede que o fluxo do programa
			 * prossiga enquanto o formulário de splah
			 * continuar sendo visível.
			 */
			;
