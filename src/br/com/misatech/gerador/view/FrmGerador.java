...
public class FrmGerador extends JInternalFrame {
	...
	public FrmGerador() {
		...
		pnlDados = new JPanel();
		pnlDados.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Dados", TitledBorder.LEADING,
		...
		btnConfigPerfil
				.setIcon(new ImageIcon(FrmGerador.class.getResource("/br/com/misatech/gerador/view/images/cog.png")));
		btnConfigPerfil.setBounds(330, 60, 30, 30);
		pnlDados.add(btnConfigPerfil);

		pnlTecnologias = new JPanel();
		pnlTecnologias.setLayout(null);
		pnlTecnologias.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Tecnologia",
		...
		pnlLog = new JPanel();
		pnlLog.setBorder(
				new TitledBorder(null, "Log", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		btnLimparLog
				.setIcon(new ImageIcon(FrmGerador.class.getResource("/br/com/misatech/gerador/view/images/cross.png")));
		...
		pnlTipoComponente.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Tipo de Componente",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		pnlTabelas.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Tabelas do banco: ",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		spnlTabDisponivel.setViewportBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
				"Dispon\u00EDveis", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
		...
		spnlTabSelecionadas.setViewportBorder(
				new TitledBorder(null, "Selecionadas", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
		...
		btnTodosDireita.setIcon(
				new ImageIcon(FrmGerador.class.getResource("/br/com/misatech/gerador/view/images/fastforward.png")));
		...
		btnSelDireita
				.setIcon(new ImageIcon(FrmGerador.class.getResource("/br/com/misatech/gerador/view/images/right.png")));
		...
		btnSelEsquerda
				.setIcon(new ImageIcon(FrmGerador.class.getResource("/br/com/misatech/gerador/view/images/left.png")));
		...
		btnTodosEsquerda.setIcon(
				new ImageIcon(FrmGerador.class.getResource("/br/com/misatech/gerador/view/images/rewind.png")));
		...
		btnAjudaPacote
				.setIcon(new ImageIcon(FrmGerador.class.getResource("/br/com/misatech/gerador/view/images/help.png")));
